...
function ProductList({ onHomeClick }) {
    ...
    // Calculate total quantity of items for the cart icon badge
        ...
        },
        {
            ...
            plants: [
                ...
                },
                {
                    ...
                    description: "Repels flies and mosquitoes, great for cooking.",
                    cost: "$9"
                },
                {
                    name: "Catnip",
                        ...
                        <div key={index}>
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => {
                                    // Check if item is already in cart to disable the button
                                    const isAddedToCart = cart.some(item => item.name === plant.name);
                                    ...
                                    return (
                                        <div className="product-card" key={plantIndex}>
                                            ...
                                            <button 
                                                ...
                                                style={{ backgroundColor: isAddedToCart ? 'gray' : '#4CAF50' }}
                                            >
